...
func Cors(origins ...string) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.Writer.Header().Add("Access-Control-Allow-Headers", "Access-Control-Allow-Headers,Accept,Authorization,X-Requested-With")
		c.Writer.Header().Add("Access-Control-Expose-Headers", "Access-Control-Allow-Headers,Accept,Authorization,X-Requested-With")
